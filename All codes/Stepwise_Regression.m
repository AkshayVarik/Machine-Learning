...
images_train_test=images_test(4001:end,:);
dataspace=[words_train_train image_features_train_train images_train_train];
testspace=[words_train_test image_features_train_test images_train_test];
